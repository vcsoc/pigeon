...
- A dashed placement placeholder aligns with sibling icons for before/after insertion, and indents one tree level for an inside drop. After markers appear below expanded descendants, not through the middle of their branch. Root and left-gutter moves show the destination level.
