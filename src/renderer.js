...
function applyStaticIcons() {
  ...
  const preferenceIcons = { general:'settings', indexing:'folder', appearance:'palette', sidebar:'folder', controls:'filter', preview:'eye', screenshot:'camera', shortcuts:'key', notifications:'bell', password:'lock', 'auto-import':'download', 'ai-search':'search', 'ai-models':'smart', mcp:'link', developer:'code' };
