...
function updateYouTubeDownloadPreferenceState(){const enabled=document.querySelector('[data-pref="youtubeAutoDownload"]')?.checked!==false,quality=document.querySelector('[data-pref="youtubeDownloadQuality"]'),description=$('#youtube-download-quality-description');if(quality)quality.disabled=!enabled;if(description)description.textContent=enabled?'1080p video and audio are combined locally before the completed file appears in Pigeon.':'Quality applies only when automatic YouTube downloads are enabled.';}
...
function installYouTubeDownloadPreferences(){const page=document.querySelector('[data-preference-content="general"]');if(!page||page.querySelector('[data-pref="youtubeDownloadQuality"]'))return;page.querySelector('.preference-card:nth-last-child(2)')?.insertAdjacentHTML('beforebegin','<div class="preference-card"><h3>YouTube imports</h3><p>Choose whether browser-extension drops keep a playable YouTube link or download a local video file.</p><label><input type="checkbox" data-pref="youtubeAutoDownload" checked /> Automatically download YouTube videos</label><p>Off creates a linked asset with its thumbnail and canonical address. It plays inline and requires an internet connection.</p><div class="preference-row"><span>Download quality</span><select data-pref="youtubeDownloadQuality"><option value="360">360p</option><option value="720">720p</option><option value="1080">1080p</option></select></div><p id="youtube-download-quality-description">1080p video and audio are combined locally before the completed file appears in Pigeon.</p></div>');document.querySelector('[data-pref="youtubeAutoDownload"]').addEventListener('change',()=>{collectPreferenceInputs();updateYouTubeDownloadPreferenceState();});}
