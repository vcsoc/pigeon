...
contextBridge.exposeInMainWorld('pigeon', {
  ...
  moveCollection: (id, parentId, placement) => ipcRenderer.invoke('collection:move', { id, parentId, ...(placement?{placement}:{}) }),
  ...
  moveSmartFolder: (id, parentId, placement) => ipcRenderer.invoke('smart-folder:move', { id, parentId, ...(placement?{placement}:{}) }),
  ...
  setupPlugin: (id) => ipcRenderer.invoke('plugins:setup', id),
  preparePlugin: (id) => ipcRenderer.invoke('plugins:prepare', id),
  cancelPluginSetup: (id) => ipcRenderer.invoke('plugins:cancel-setup', id),
  checkPluginHealth: (id) => ipcRenderer.invoke('plugins:health', id),
  importPluginModel: (id) => ipcRenderer.invoke('plugins:import-model', id),
  removePluginModel: (id) => ipcRenderer.invoke('plugins:remove-model', id),
  ...
  configurePlugin: (id, config) => ipcRenderer.invoke('plugins:configure', { id, config }),
  openPluginsFolder: (id = null) => ipcRenderer.invoke('plugins:open-folder', id),
