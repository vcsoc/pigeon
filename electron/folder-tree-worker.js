...
function discoverPhysicalFolders(location, folders) {
  ...
  while (pending.length) {
    ...
    for (const entry of entries) {
      // Do not traverse junctions or symbolic links: their targets may escape the indexed root.
