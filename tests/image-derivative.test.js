...
test('image derivatives convert, rotate, crop, and apply tonal adjustments',async()=>{
  ...
  try{
    ...
    const result=await renderImageDerivative(source,target,{format:'webp',rotate:90,crop:{normalized:true,x:.25,y:.25,width:.5,height:.5},grayscale:true,negative:true,sepia:true,brightness:1.2,contrast:1.1,annotations:[{type:'rect',x:5,y:5,width:20,height:15,color:'#ffffff',stroke:2}]});
